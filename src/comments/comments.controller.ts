...
export class CommentsController {
  ...
  async create(@Body() createCommentDto: CreateCommentDto, @Request() req: any) {
    ...
    return this.commentsService.create(createCommentDto, String(req.user.uid), authorName)
  }
  ...
  @Patch(':id')
  @UseGuards(AuthGuard)
  update(@Param('id') id: string, @Body() updateCommentDto: any, @Request() req: any) {
    ...
    return this.commentsService.update(id, validationResult.data, String(req.user.uid))
  }
